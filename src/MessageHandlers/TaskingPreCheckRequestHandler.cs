...
public partial class MessageHandler<T> {
    private void TaskingPreCheckRequestHandler(MessageFormats.HostServices.Sensor.TaskingPreCheckRequest? message, MessageFormats.Common.DirectToApp fullMessage) {
        ...
        using (var scope = _serviceProvider.CreateScope()) {
            ...
            MessageFormats.HostServices.Sensor.TaskingPreCheckResponse? returnResponse = null;
            ...
            MessageFormats.HostServices.Sensor.TaskingPreCheckRequest? pluginResult =
               _pluginLoader.CallPlugins<MessageFormats.HostServices.Sensor.TaskingPreCheckRequest?, Plugins.PluginBase>(
            ...
            void TaskingPreCheckResponseCallback(object? sender, MessageFormats.HostServices.Sensor.TaskingPreCheckResponse _response) {
                if (_response.ResponseHeader.TrackingId == message.RequestHeader.TrackingId) {
                    ...
                    MessageHandler<MessageFormats.HostServices.Sensor.TaskingPreCheckResponse>.MessageReceivedEvent -= TaskingPreCheckResponseCallback;
                }
            }
