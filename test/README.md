...
6. A successful test run should emit something like this to the debug console
    ...
    ```plaintext
        ...
        /workspaces/hostsvc-sensor/test/integrationTests/bin/Debug/net6.0/integrationTests.dll
        ...
        Waiting for 'hostsvc-Sensor-test-host' to come online...
        hostsvc-Sensor-test-host is online.  Starting tests
...
1. A successful test run should emit something like this to the debug console
    ...
    ```plaintext
        A total of 1 test files matched the specified pattern.
        /workspaces/hostsvc-sensor/test/unitTests/bin/Debug/net6.0/unitTests.dll
        [xUnit.net 00:00:00.00] xUnit.net VSTest Adapter v2.4.5+1caef2f33e (64-bit .NET 6.0.16)
